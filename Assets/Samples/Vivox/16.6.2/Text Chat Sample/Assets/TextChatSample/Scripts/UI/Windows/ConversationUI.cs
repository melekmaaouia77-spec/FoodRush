...
public class ConversationUI : MonoBehaviour
{
    ...
    // Needed as a faux message ID since the local players doesn't get notified when their DM is sent to another person.
    ...
    public async Task SetupConversation(string conversationId, ConversationType conversationType)
    {
        ...
        switch (conversationType)
        {
            ...
            case ConversationType.DirectedMessageConversation:
            {
                ...
                InfoText.text = $"players ID: {conversationId}";
