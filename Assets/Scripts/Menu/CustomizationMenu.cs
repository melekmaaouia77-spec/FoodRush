...
public class CustomizationMenu : Panel
{
    ...
    private string[] characters = { "Cube", "Capsule", "Sphere" , "Character" };
    ...
    private void ApplyData()
    {
        ...
        // Only apply color if character is NOT the special "Character"
        if (characters[character] != "Character")
        {
            characterText.color = colors[color];
        }
        else
        {
            characterText.color = Color.white; // Or any default color
        }
